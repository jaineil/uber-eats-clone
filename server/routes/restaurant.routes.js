...
restaurantRoutes.get('/fetch-restaurant/:restaurantId', restaurantController.fetchRestaurantMeta);
...
restaurantRoutes.get('/fetch-dish/:dishId', restaurantController.fetchOneDishForRestaurant);
restaurantRoutes.post('/update-dish', restaurantController.updateDish);
restaurantRoutes.get('/fetch-dishes/:restaurantId', restaurantController.fetchAllDishesForRestaurant);
